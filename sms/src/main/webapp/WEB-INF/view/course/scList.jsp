        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'student_name', title: '选课学生', width: 150},
                ...
                if (selectLength === 0) {
                    ...
                    $.messager.confirm("消息提醒", "删除后将无法恢复该课程信息! 确定继续?", function (r) {
                        if (r) {
                            $.ajax({
                                type: "post",
                                url: "deleteSc?t" + new Date().getTime(),
                                data: {ids: ids},
                                dataType: 'json',
            ...
            $("#editDialog").dialog({
                ...
                onBeforeOpen: function () {
                    ...
                    $("#edit_studentname").textbox('setValue', selectRow.student_name);

                    $("#edit_coursename").textbox('setValue', selectRow.course_name);
    ...
    <form id="addForm" method="post" action="#">
        <table id="addTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                <td>选课学生</td>
                <td colspan="1">
                    <input id="add_studentname" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="student_name" data-options="required:true, missingMessage:'请填写选课学生哟~'"/>
                </td>
            </tr>
            <tr>
                <td>课程名</td>
                <td colspan="1">
                    <input id="add_coursename" style="width: 200px; height: 30px;" class="easyui-textbox"
    ...
    <form id="editForm" method="post" action="#">
        ...
        <table id="editTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                <td>选课学生</td>
                <td colspan="1">
                    <input id="edit_studentname" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="student_name" data-options="required:true, missingMessage:'请填写选课学生哟~'"/>
                </td>
            </tr>
            <tr>
                <td>课程名</td>
                <td colspan="1">
                    <input id="edit_coursename" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="course_name" data-options="required:true, missingMessage:'请填写课程名哟~'"/>
                </td>
            </tr>
        </table>
